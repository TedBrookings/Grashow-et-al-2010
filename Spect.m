function varargout = Spect(Signal, varargin)
% [FrequencyList, Power] = Spect(Signal, t, PlotSubject)
%
...
for Row = 1:NumFreq
  ...
  Power(Row) = mean(FilteredSig.*conj(FilteredSig));    % Record the amplitude of the result
end
...
switch(nargout)
 ...
 otherwise, varargout = {FreqList, Power};
end
